...
public class FbaInventoryApiTest {
    ...
    public void deleteInventoryItemTest() throws Exception {
        ...
        ApiResponse<DeleteInventoryItemResponse> response =
                api.deleteInventoryItemWithHttpInfo(sellerSku, marketplaceId);
    ...
    public void getInventorySummariesTest() throws Exception {
        ...
        ApiResponse<GetInventorySummariesResponse> response = api.getInventorySummariesWithHttpInfo(
                granularityType, granularityId, marketplaceIds, null, null, null, null, null);
