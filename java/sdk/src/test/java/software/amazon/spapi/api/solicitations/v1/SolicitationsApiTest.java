...
public class SolicitationsApiTest {
    ...
    public void createProductReviewAndSellerFeedbackSolicitationTest() throws Exception {
        ...
        ApiResponse<CreateProductReviewAndSellerFeedbackSolicitationResponse> response =
                api.createProductReviewAndSellerFeedbackSolicitationWithHttpInfo(amazonOrderId, marketplaceIds);
    ...
    public void getSolicitationActionsForOrderTest() throws Exception {
        ...
        ApiResponse<GetSolicitationActionsForOrderResponse> response =
                api.getSolicitationActionsForOrderWithHttpInfo(amazonOrderId, marketplaceIds);
