...
public class QueriesApi {
    ...
    /**
     * Cancels the query specified by the &#x60;queryId&#x60; parameter. Only queries with a non-terminal
     * &#x60;processingStatus&#x60; (&#x60;IN_QUEUE&#x60;, &#x60;IN_PROGRESS&#x60;) can be cancelled. Cancelling a query
     * that already has a &#x60;processingStatus&#x60; of &#x60;CANCELLED&#x60; will no-op. Cancelled queries are
     * returned in subsequent calls to the &#x60;getQuery&#x60; and &#x60;getQueries&#x60; operations. **Usage Plan:** |
    ...
    public void cancelQuery(String queryId, String restrictedDataToken) throws ApiException, LWAException {
        cancelQueryWithHttpInfo(queryId, restrictedDataToken);
    }
    ...
    public void cancelQuery(String queryId) throws ApiException, LWAException {
        cancelQueryWithHttpInfo(queryId, null);
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Void> cancelQueryWithHttpInfo(String queryId, String restrictedDataToken)
            throws ApiException, LWAException {
    ...
    public ApiResponse<Void> cancelQueryWithHttpInfo(String queryId) throws ApiException, LWAException {
        return cancelQueryWithHttpInfo(queryId, null);
    }

    /**
     * (asynchronously) Cancels the query specified by the &#x60;queryId&#x60; parameter. Only queries with a
     * non-terminal &#x60;processingStatus&#x60; (&#x60;IN_QUEUE&#x60;, &#x60;IN_PROGRESS&#x60;) can be cancelled.
     * Cancelling a query that already has a &#x60;processingStatus&#x60; of &#x60;CANCELLED&#x60; will no-op. Cancelled
     * queries are returned in subsequent calls to the &#x60;getQuery&#x60; and &#x60;getQueries&#x60; operations.
     * **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0222 | 10 | The
    ...
    public okhttp3.Call cancelQueryAsync(String queryId, final ApiCallback<Void> callback)
            throws ApiException, LWAException {
        return cancelQueryAsync(queryId, callback, null);
    }
    /**
     * (asynchronously) Cancels the query specified by the &#x60;queryId&#x60; parameter. Only queries with a
     * non-terminal &#x60;processingStatus&#x60; (&#x60;IN_QUEUE&#x60;, &#x60;IN_PROGRESS&#x60;) can be cancelled.
    ...
    /**
     * Creates a Data Kiosk query request. **Note:** The retention of a query varies based on the fields requested. Each
     * field within a schema is annotated with a &#x60;@resultRetention&#x60; directive that defines how long a query
     ...
     * retention of the query. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ---- | | 0.0167 | 15 |
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public CreateQueryResponse createQuery(CreateQuerySpecification body, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<CreateQueryResponse> resp = createQueryWithHttpInfo(body, restrictedDataToken);
        return resp.getData();
    }
    ...
    public CreateQueryResponse createQuery(CreateQuerySpecification body) throws ApiException, LWAException {
        ApiResponse<CreateQueryResponse> resp = createQueryWithHttpInfo(body, null);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<CreateQueryResponse> createQueryWithHttpInfo(
            CreateQuerySpecification body, String restrictedDataToken) throws ApiException, LWAException {
    ...
    public ApiResponse<CreateQueryResponse> createQueryWithHttpInfo(CreateQuerySpecification body)
            throws ApiException, LWAException {
        return createQueryWithHttpInfo(body, null);
    }

    /**
     * (asynchronously) Creates a Data Kiosk query request. **Note:** The retention of a query varies based on the
     * fields requested. Each field within a schema is annotated with a &#x60;@resultRetention&#x60; directive that
     * defines how long a query containing that field will be retained. When a query contains multiple fields with
     * different retentions, the shortest (minimum) retention is applied. The retention of a query&#x27;s resulting
     * documents always matches the retention of the query. **Usage Plan:** | Rate (requests per second) | Burst | |
     * ---- | ---- | | 0.0167 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate
    ...
    public okhttp3.Call createQueryAsync(CreateQuerySpecification body, final ApiCallback<CreateQueryResponse> callback)
            throws ApiException, LWAException {
        return createQueryAsync(body, callback, null);
    }
    /**
     * (asynchronously) Creates a Data Kiosk query request. **Note:** The retention of a query varies based on the
     * fields requested. Each field within a schema is annotated with a &#x60;@resultRetention&#x60; directive that
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public okhttp3.Call createQueryAsync(
    ...
    /**
     * Returns the information required for retrieving a Data Kiosk document&#x27;s contents. See the
     * &#x60;createQuery&#x60; operation for details about document retention. **Usage Plan:** | Rate (requests per
     * second) | Burst | | ---- | ---- | | 0.0167 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public GetDocumentResponse getDocument(String documentId, String restrictedDataToken)
            throws ApiException, LWAException {
        ApiResponse<GetDocumentResponse> resp = getDocumentWithHttpInfo(documentId, restrictedDataToken);
        return resp.getData();
    }
    ...
    public GetDocumentResponse getDocument(String documentId) throws ApiException, LWAException {
        ApiResponse<GetDocumentResponse> resp = getDocumentWithHttpInfo(documentId, null);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetDocumentResponse> getDocumentWithHttpInfo(String documentId, String restrictedDataToken)
            throws ApiException, LWAException {
    ...
    public ApiResponse<GetDocumentResponse> getDocumentWithHttpInfo(String documentId)
            throws ApiException, LWAException {
        return getDocumentWithHttpInfo(documentId, null);
    }

    /**
     * (asynchronously) Returns the information required for retrieving a Data Kiosk document&#x27;s contents. See the
     * &#x60;createQuery&#x60; operation for details about document retention. **Usage Plan:** | Rate (requests per
     * second) | Burst | | ---- | ---- | | 0.0167 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns
     * the usage plan rate limits that were applied to the requested operation, when available. The table above
     * indicates the default rate and burst values for this operation. Selling partners whose business demands require
    ...
    public okhttp3.Call getDocumentAsync(String documentId, final ApiCallback<GetDocumentResponse> callback)
            throws ApiException, LWAException {
        return getDocumentAsync(documentId, callback, null);
    }
    /**
     * (asynchronously) Returns the information required for retrieving a Data Kiosk document&#x27;s contents. See the
     * &#x60;createQuery&#x60; operation for details about document retention. **Usage Plan:** | Rate (requests per
    ...
    private okhttp3.Call getQueriesValidateBeforeCall(
            List<String> processingStatuses,
            Integer pageSize,
            OffsetDateTime createdSince,
            OffsetDateTime createdUntil,
     ...
     * operation for details about query retention. **Usage Plan:** | Rate (requests per second) | Burst | | ---- | ----
     * | | 0.0222 | 10 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage plan rate limits that
    ...
    public GetQueriesResponse getQueries(
            ...
            throws ApiException, LWAException {
        ApiResponse<GetQueriesResponse> resp = getQueriesWithHttpInfo(
                processingStatuses, pageSize, createdSince, createdUntil, paginationToken, restrictedDataToken);
        return resp.getData();
    }
    ...
    public GetQueriesResponse getQueries(
            ...
            String paginationToken)
            throws ApiException, LWAException {
        ApiResponse<GetQueriesResponse> resp =
                getQueriesWithHttpInfo(processingStatuses, pageSize, createdSince, createdUntil, paginationToken, null);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<GetQueriesResponse> getQueriesWithHttpInfo(
            List<String> processingStatuses,
            Integer pageSize,
            OffsetDateTime createdSince,
            OffsetDateTime createdUntil,
    ...
    public ApiResponse<GetQueriesResponse> getQueriesWithHttpInfo(
            ...
            String paginationToken)
            throws ApiException, LWAException {
        return getQueriesWithHttpInfo(processingStatuses, pageSize, createdSince, createdUntil, paginationToken, null);
    }

    /**
     * (asynchronously) Returns details for the Data Kiosk queries that match the specified filters. See the
     * &#x60;createQuery&#x60; operation for details about query retention. **Usage Plan:** | Rate (requests per second)
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public okhttp3.Call getQueriesAsync(
            List<String> processingStatuses,
            Integer pageSize,
            OffsetDateTime createdSince,
            OffsetDateTime createdUntil,
            ...
            throws ApiException, LWAException {
        return getQueriesAsync(
                processingStatuses, pageSize, createdSince, createdUntil, paginationToken, callback, null);
    }
    /**
     * (asynchronously) Returns details for the Data Kiosk queries that match the specified filters. See the
     * &#x60;createQuery&#x60; operation for details about query retention. **Usage Plan:** | Rate (requests per second)
    ...
    /**
     * Returns query details for the query specified by the &#x60;queryId&#x60; parameter. See the
     * &#x60;createQuery&#x60; operation for details about query retention. **Usage Plan:** | Rate (requests per second)
     * | Burst | | ---- | ---- | | 2.0 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage
    ...
    public Query getQuery(String queryId, String restrictedDataToken) throws ApiException, LWAException {
        ApiResponse<Query> resp = getQueryWithHttpInfo(queryId, restrictedDataToken);
        return resp.getData();
    }
    ...
    public Query getQuery(String queryId) throws ApiException, LWAException {
        ApiResponse<Query> resp = getQueryWithHttpInfo(queryId, null);
        return resp.getData();
    }
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public ApiResponse<Query> getQueryWithHttpInfo(String queryId, String restrictedDataToken)
            throws ApiException, LWAException {
    ...
    public ApiResponse<Query> getQueryWithHttpInfo(String queryId) throws ApiException, LWAException {
        return getQueryWithHttpInfo(queryId, null);
    }

    /**
     * (asynchronously) Returns query details for the query specified by the &#x60;queryId&#x60; parameter. See the
     * &#x60;createQuery&#x60; operation for details about query retention. **Usage Plan:** | Rate (requests per second)
     * | Burst | | ---- | ---- | | 2.0 | 15 | The &#x60;x-amzn-RateLimit-Limit&#x60; response header returns the usage
     * plan rate limits that were applied to the requested operation, when available. The table above indicates the
     * default rate and burst values for this operation. Selling partners whose business demands require higher
    ...
    public okhttp3.Call getQueryAsync(String queryId, final ApiCallback<Query> callback)
            throws ApiException, LWAException {
        return getQueryAsync(queryId, callback, null);
    }
    /**
     * (asynchronously) Returns query details for the query specified by the &#x60;queryId&#x60; parameter. See the
     * &#x60;createQuery&#x60; operation for details about query retention. **Usage Plan:** | Rate (requests per second)
