...
public class DefaultApi {
    ...
    private okhttp3.Call listFinancialEventGroupsCall(
        ...
        if (financialEventGroupStartedBefore != null)
            localVarQueryParams.addAll(
                    apiClient.parameterToPair("FinancialEventGroupStartedBefore", financialEventGroupStartedBefore));
        if (financialEventGroupStartedAfter != null)
            localVarQueryParams.addAll(
                    apiClient.parameterToPair("FinancialEventGroupStartedAfter", financialEventGroupStartedAfter));
    ...
    private okhttp3.Call listFinancialEventsValidateBeforeCall(
            Integer maxResultsPerPage,
            OffsetDateTime postedAfter,
            OffsetDateTime postedBefore,
            String nextToken,
    ...
    private okhttp3.Call listFinancialEventsByGroupIdValidateBeforeCall(
            String eventGroupId,
            Integer maxResultsPerPage,
            OffsetDateTime postedAfter,
            OffsetDateTime postedBefore,
        ...
        if (eventGroupId == null) {
            throw new ApiException(
                    "Missing the required parameter 'eventGroupId' when calling listFinancialEventsByGroupId(Async)");
        }
