...
public class UploadsApi {
    ...
    public CreateUploadDestinationResponse createUploadDestinationForResource(
            ...
            throws ApiException, LWAException {
        ApiResponse<CreateUploadDestinationResponse> resp = createUploadDestinationForResourceWithHttpInfo(
                marketplaceIds, contentMD5, resource, contentType, restrictedDataToken);
        return resp.getData();
    }
    ...
    public CreateUploadDestinationResponse createUploadDestinationForResource(
        ...
        ApiResponse<CreateUploadDestinationResponse> resp =
                createUploadDestinationForResourceWithHttpInfo(marketplaceIds, contentMD5, resource, contentType, null);
        return resp.getData();
    }
    ...
    public ApiResponse<CreateUploadDestinationResponse> createUploadDestinationForResourceWithHttpInfo(
        ...
        if (restrictedDataToken != null) {
            ...
            request = RestrictedDataTokenSigner.sign(
                    request, restrictedDataToken, "UploadsApi-createUploadDestinationForResource");
    ...
    public ApiResponse<CreateUploadDestinationResponse> createUploadDestinationForResourceWithHttpInfo(
            List<String> marketplaceIds, String contentMD5, String resource, String contentType)
            throws ApiException, LWAException {
        return createUploadDestinationForResourceWithHttpInfo(marketplaceIds, contentMD5, resource, contentType, null);
    }
    ...
    public okhttp3.Call createUploadDestinationForResourceAsync(
            ...
            throws ApiException, LWAException {
        return createUploadDestinationForResourceAsync(
                marketplaceIds, contentMD5, resource, contentType, callback, null);
    }
    /**
     * (asynchronously) Creates an upload destination, returning the information required to upload a file to the
     * destination and to programmatically access the file. **Usage Plan:** | Rate (requests per second) | Burst | |
