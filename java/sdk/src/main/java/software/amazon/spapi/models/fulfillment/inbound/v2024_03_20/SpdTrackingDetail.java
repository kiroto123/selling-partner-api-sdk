...
@Schema(description = "Contains information related to Small Parcel Delivery (SPD) shipment tracking.")
public class SpdTrackingDetail {
     ...
     */
    @Schema(description = "List of Small Parcel Delivery (SPD) tracking items.")
