...
public class InvoicesApi {
    ...
    private okhttp3.Call getInvoicesCall(
        ...
        if (transactionIdentifierName != null)
            localVarQueryParams.addAll(
                    apiClient.parameterToPair("transactionIdentifierName", transactionIdentifierName));
        ...
        if (dateStart != null) localVarQueryParams.addAll(apiClient.parameterToPair("dateStart", dateStart));
        if (series != null) localVarQueryParams.addAll(apiClient.parameterToPair("series", series));
    ...
    private okhttp3.Call getInvoicesValidateBeforeCall(
            String marketplaceId,
            String transactionIdentifierName,
            Integer pageSize,
            OffsetDateTime dateEnd,
    ...
    private okhttp3.Call getInvoicesExportsValidateBeforeCall(
            String marketplaceId,
            OffsetDateTime dateStart,
            String nextToken,
            Integer pageSize,
        ...
        if (marketplaceId == null) {
            throw new ApiException(
                    "Missing the required parameter 'marketplaceId' when calling getInvoicesExports(Async)");
        }
