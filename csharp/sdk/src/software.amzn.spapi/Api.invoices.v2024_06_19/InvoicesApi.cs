...
namespace software.amzn.spapi.Api.invoices.v2024_06_19
{
    /// <summary>
    ...
    public partial class InvoicesApi : IInvoicesApi
    {
        ...
        /// <returns></returns>
        public InvoicesApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse< ExportInvoicesResponse > CreateInvoicesExportWithHttpInfo (ExportInvoicesRequest body)
        {
            ...
            {
                // Exception exception = new Exception("CreateInvoicesExport", localVarResponse.ErrorException);
            ...
            return new ApiResponse<ExportInvoicesResponse>(localVarResponse.StatusCode,
        ...
        public ApiResponse< GetInvoiceResponse > GetInvoiceWithHttpInfo (string marketplaceId, string invoiceId)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInvoice", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
        ...
        public ApiResponse< GetInvoicesResponse > GetInvoicesWithHttpInfo (string marketplaceId, string? transactionIdentifierName = null, int? pageSize = null, DateTime? dateEnd = null, string? transactionType = null, string? transactionIdentifierId = null, DateTime? dateStart = null, string? series = null, string? nextToken = null, string? sortOrder = null, string? invoiceType = null, List<string>? statuses = null, string? externalInvoiceId = null, string? sortBy = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInvoices", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
        ...
        public ApiResponse< GetInvoicesAttributesResponse > GetInvoicesAttributesWithHttpInfo (string marketplaceId)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInvoicesAttributes", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<GetInvoicesAttributesResponse>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< GetInvoicesDocumentResponse > GetInvoicesDocumentWithHttpInfo (string invoicesDocumentId)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInvoicesDocument", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<GetInvoicesDocumentResponse>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< GetInvoicesExportResponse > GetInvoicesExportWithHttpInfo (string exportId)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInvoicesExport", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<GetInvoicesExportResponse>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< GetInvoicesExportsResponse > GetInvoicesExportsWithHttpInfo (string marketplaceId, DateTime? dateStart = null, string? nextToken = null, int? pageSize = null, DateTime? dateEnd = null, string? status = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInvoicesExports", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<GetInvoicesExportsResponse>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
