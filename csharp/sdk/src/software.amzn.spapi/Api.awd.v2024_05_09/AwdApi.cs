...
namespace software.amzn.spapi.Api.awd.v2024_05_09
{
    /// <summary>
    ...
    public partial class AwdApi : IAwdApi
    {
        ...
        /// <returns></returns>
        public AwdApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse<Object> CancelInboundWithHttpInfo (string orderId)
        {
            ...
            {
                // Exception exception = new Exception("CancelInbound", localVarResponse.ErrorException);
        ...
        public ApiResponse< InboundEligibility > CheckInboundEligibilityWithHttpInfo (InboundPackages body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("CheckInboundEligibility", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<InboundEligibility>(localVarResponse.StatusCode,
        ...
        public ApiResponse<Object> ConfirmInboundWithHttpInfo (string orderId)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("ConfirmInbound", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
        ...
        public ApiResponse< InboundOrderReference > CreateInboundWithHttpInfo (InboundOrderCreationData body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("CreateInbound", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<InboundOrderReference>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< InboundOrder > GetInboundWithHttpInfo (string orderId)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInbound", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<InboundOrder>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< InboundShipment > GetInboundShipmentWithHttpInfo (string shipmentId, string? skuQuantities = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInboundShipment", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<InboundShipment>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< ShipmentLabels > GetInboundShipmentLabelsWithHttpInfo (string shipmentId, string? pageType = null, string? formatType = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetInboundShipmentLabels", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<ShipmentLabels>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< ShipmentListing > ListInboundShipmentsWithHttpInfo (string? sortBy = null, string? sortOrder = null, string? shipmentStatus = null, DateTime? updatedAfter = null, DateTime? updatedBefore = null, int? maxResults = null, string? nextToken = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("ListInboundShipments", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<ShipmentListing>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< InventoryListing > ListInventoryWithHttpInfo (string? sku = null, string? sortOrder = null, string? details = null, string? nextToken = null, int? maxResults = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("ListInventory", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<InventoryListing>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse<Object> UpdateInboundWithHttpInfo (string orderId, InboundOrder body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("UpdateInbound", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
        ...
        public ApiResponse<Object> UpdateInboundShipmentTransportDetailsWithHttpInfo (string shipmentId, TransportationDetails body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("UpdateInboundShipmentTransportDetails", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
