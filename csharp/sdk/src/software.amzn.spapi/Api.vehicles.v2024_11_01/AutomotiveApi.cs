...
namespace software.amzn.spapi.Api.vehicles.v2024_11_01
{
    ...
    /// </summary>
    public interface IAutomotiveApi : IApiAccessor
    {
        ...
        ApiResponse<VehiclesResponse> GetVehicles_0WithHttpInfo (string marketplaceId, string vehicleType, string? pageToken = null, string? updatedAfter = null);
        ...
        System.Threading.Tasks.Task<VehiclesResponse> GetVehicles_0Async (string marketplaceId, string vehicleType, string? pageToken = null, string? updatedAfter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<VehiclesResponse>> GetVehicles_0AsyncWithHttpInfo (string marketplaceId, string vehicleType, string? pageToken = null, string? updatedAfter = null);
    ...
    public partial class AutomotiveApi : IAutomotiveApi
    {
        ...
        /// <returns></returns>
        public AutomotiveApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        /// <param name="updatedAfter">Date in ISO 8601 format, if provided only vehicles which are modified/added to Amazon&#39;s catalog after this date will be returned. (optional)</param>
        /// <returns>VehiclesResponse</returns>
        public VehiclesResponse GetVehicles_0 (string marketplaceId, string vehicleType, string? pageToken = null, string? updatedAfter = null)
        {
             ApiResponse<VehiclesResponse> localVarResponse = GetVehicles_0WithHttpInfo(marketplaceId, vehicleType, pageToken, updatedAfter);
        ...
        /// <param name="updatedAfter">Date in ISO 8601 format, if provided only vehicles which are modified/added to Amazon&#39;s catalog after this date will be returned. (optional)</param>
        /// <returns>ApiResponse of VehiclesResponse</returns>
        public ApiResponse< VehiclesResponse > GetVehicles_0WithHttpInfo (string marketplaceId, string vehicleType, string? pageToken = null, string? updatedAfter = null)
        {
            // verify the required parameter 'marketplaceId' is set
            if (marketplaceId == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceId' when calling AutomotiveApi->GetVehicles_0");
            // verify the required parameter 'vehicleType' is set
            if (vehicleType == null)
                throw new ApiException(400, "Missing required parameter 'vehicleType' when calling AutomotiveApi->GetVehicles_0");
        ...
        /// <param name="updatedAfter">Date in ISO 8601 format, if provided only vehicles which are modified/added to Amazon&#39;s catalog after this date will be returned. (optional)</param>
        /// <returns>Task of VehiclesResponse</returns>
        public async System.Threading.Tasks.Task<VehiclesResponse> GetVehicles_0Async (string marketplaceId, string vehicleType, string? pageToken = null, string? updatedAfter = null)
        {
             ApiResponse<VehiclesResponse> localVarResponse = await GetVehicles_0AsyncWithHttpInfo(marketplaceId, vehicleType, pageToken, updatedAfter);
             return localVarResponse.Data;
        ...
        /// <param name="updatedAfter">Date in ISO 8601 format, if provided only vehicles which are modified/added to Amazon&#39;s catalog after this date will be returned. (optional)</param>
        /// <returns>Task of ApiResponse (VehiclesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VehiclesResponse>> GetVehicles_0AsyncWithHttpInfo (string marketplaceId, string vehicleType, string? pageToken = null, string? updatedAfter = null)
        {
            // verify the required parameter 'marketplaceId' is set
            if (marketplaceId == null)
                throw new ApiException(400, "Missing required parameter 'marketplaceId' when calling AutomotiveApi->GetVehicles_0");
        ...
        public class Builder
        {
            ...
            public AutomotiveApi Build() 
            {
                ...
                return new AutomotiveApi(configuration);
            }
        }
