...
namespace software.amzn.spapi.Api.vendor.df.shipping.v2021_12_28
{
    ...
    public interface IVendorShippingApi : IApiAccessor
    {
        ...
        /// <param name="purchaseOrderNumber">The &#x60;purchaseOrderNumber&#x60; for the packing slip that you want.</param>
        ...
        /// </remarks>
        /// <exception cref="software.amzn.spapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createdAfter">Packing slips that become available after this date and time will be included in the result. Values are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.</param>
        /// <param name="createdBefore">Packing slips that became available before this date and time will be included in the result. Values are in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.</param>
    ...
    public partial class VendorShippingApi : IVendorShippingApi
    {
        ...
        /// <returns></returns>
        public VendorShippingApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse< PackingSlip > GetPackingSlipWithHttpInfo (string purchaseOrderNumber)
        {
            ...
            {
                // Exception exception = new Exception("GetPackingSlip", localVarResponse.ErrorException);
            ...
            return new ApiResponse<PackingSlip>(localVarResponse.StatusCode,
        ...
        public ApiResponse< PackingSlipList > GetPackingSlipsWithHttpInfo (DateTime createdAfter, DateTime createdBefore, string? shipFromPartyId = null, int? limit = null, string? sortOrder = null, string? nextToken = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetPackingSlips", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<PackingSlipList>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< TransactionReference > SubmitShipmentConfirmationsWithHttpInfo (SubmitShipmentConfirmationsRequest body)
        {
            ...
            return new ApiResponse<TransactionReference>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< TransactionReference > SubmitShipmentStatusUpdatesWithHttpInfo (SubmitShipmentStatusUpdatesRequest body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("SubmitShipmentStatusUpdates", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
