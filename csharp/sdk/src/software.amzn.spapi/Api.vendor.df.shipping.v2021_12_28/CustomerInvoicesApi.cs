...
namespace software.amzn.spapi.Api.vendor.df.shipping.v2021_12_28
{
    ...
    public partial class CustomerInvoicesApi : ICustomerInvoicesApi
    {
        ...
        /// <returns></returns>
        public CustomerInvoicesApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse< CustomerInvoice > GetCustomerInvoiceWithHttpInfo (string purchaseOrderNumber)
        {
            ...
            {
                // Exception exception = new Exception("GetCustomerInvoice", localVarResponse.ErrorException);
            ...
            return new ApiResponse<CustomerInvoice>(localVarResponse.StatusCode,
        ...
        public ApiResponse< CustomerInvoiceList > GetCustomerInvoicesWithHttpInfo (DateTime createdAfter, DateTime createdBefore, string? shipFromPartyId = null, int? limit = null, string? sortOrder = null, string? nextToken = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetCustomerInvoices", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<CustomerInvoiceList>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
