...
namespace software.amzn.spapi.Api.vendor.df.shipping.v2021_12_28
{
    ...
    public partial class VendorShippingLabelsApi : IVendorShippingLabelsApi
    {
        ...
        /// <returns></returns>
        public VendorShippingLabelsApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse< ShippingLabel > CreateShippingLabelsWithHttpInfo (string purchaseOrderNumber, CreateShippingLabelsRequest body)
        {
            ...
            {
                // Exception exception = new Exception("CreateShippingLabels", localVarResponse.ErrorException);
            ...
            return new ApiResponse<ShippingLabel>(localVarResponse.StatusCode,
        ...
        public ApiResponse< ShippingLabel > GetShippingLabelWithHttpInfo (string purchaseOrderNumber)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetShippingLabel", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
        ...
        public ApiResponse< ShippingLabelList > GetShippingLabelsWithHttpInfo (DateTime createdAfter, DateTime createdBefore, string? shipFromPartyId = null, int? limit = null, string? sortOrder = null, string? nextToken = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("GetShippingLabels", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
            ...
            return new ApiResponse<ShippingLabelList>(localVarResponse.StatusCode,
                ConvertToMultimap(localVarResponse),
        ...
        public ApiResponse< TransactionReference > SubmitShippingLabelRequestWithHttpInfo (SubmitShippingLabelsRequest body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("SubmitShippingLabelRequest", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
