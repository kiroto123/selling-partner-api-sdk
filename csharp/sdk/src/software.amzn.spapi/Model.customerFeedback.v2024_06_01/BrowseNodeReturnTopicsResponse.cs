...
namespace software.amzn.spapi.Model.customerFeedback.v2024_06_01
{
    ...
    /// </summary>
    [DataContract(Name = "BrowseNodeReturnTopicsResponse")]
    public partial class BrowseNodeReturnTopicsResponse : IValidatableObject
    {
        /// <summary>
        ...
        public BrowseNodeReturnTopicsResponse(string browseNodeId = default(string), string displayName = default(string), string marketplaceId = default(string), string countryCode = default(string), DateRange dateRange = default(DateRange), List<BrowseNodeReturnTopics> topics = default(List<BrowseNodeReturnTopics>))
        {
            // to ensure "browseNodeId" is required (not null)
            if (browseNodeId == null)
            {
                throw new ArgumentNullException("browseNodeId is a required property for BrowseNodeReturnTopicsResponse and cannot be null");
            }
            this.BrowseNodeId = browseNodeId;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for BrowseNodeReturnTopicsResponse and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "marketplaceId" is required (not null)
            if (marketplaceId == null)
            {
                throw new ArgumentNullException("marketplaceId is a required property for BrowseNodeReturnTopicsResponse and cannot be null");
            }
            this.MarketplaceId = marketplaceId;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for BrowseNodeReturnTopicsResponse and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "dateRange" is required (not null)
            if (dateRange == null)
            {
                throw new ArgumentNullException("dateRange is a required property for BrowseNodeReturnTopicsResponse and cannot be null");
            }
            this.DateRange = dateRange;
            // to ensure "topics" is required (not null)
            if (topics == null)
            {
                throw new ArgumentNullException("topics is a required property for BrowseNodeReturnTopicsResponse and cannot be null");
            }
            this.Topics = topics;
        }
