...
namespace software.amzn.spapi.Api.vendor.invoices.v1
{
    /// <summary>
    ...
    public partial class VendorPaymentsApi : IVendorPaymentsApi
    {
        ...
        /// <returns></returns>
        public VendorPaymentsApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse< SubmitInvoicesResponse > SubmitInvoicesWithHttpInfo (SubmitInvoicesRequest body)
        {
            ...
            {
                // Exception exception = new Exception("SubmitInvoices", localVarResponse.ErrorException);
            ...
            return new ApiResponse<SubmitInvoicesResponse>(localVarResponse.StatusCode,
