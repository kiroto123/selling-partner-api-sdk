...
namespace software.amzn.spapi.Api.appIntegrations.v2024_04_01
{
    /// <summary>
    ...
    public partial class AppIntegrationsApi : IAppIntegrationsApi
    {
        ...
        /// <returns></returns>
        public AppIntegrationsApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse< CreateNotificationResponse > CreateNotificationWithHttpInfo (CreateNotificationRequest body)
        {
            ...
            {
                // Exception exception = new Exception("CreateNotification", localVarResponse.ErrorException);
            ...
            return new ApiResponse<CreateNotificationResponse>(localVarResponse.StatusCode,
        ...
        public ApiResponse<Object> DeleteNotificationsWithHttpInfo (DeleteNotificationsRequest body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("DeleteNotifications", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
        ...
        public ApiResponse<Object> RecordActionFeedbackWithHttpInfo (string notificationId, RecordActionFeedbackRequest body)
        {
            ...
            if (ExceptionFactory != null)
            {
                // Exception exception = new Exception("RecordActionFeedback", localVarResponse.ErrorException);
                // if (exception != null) throw exception;
                string requestId = localVarResponse.GetHeaderValue("x-amzn-RequestId");
                ApiException exception = new ApiException(localVarStatusCode, "x-amzn-RequestId: " + requestId + "\n" + localVarResponse.Content);
                throw exception;
