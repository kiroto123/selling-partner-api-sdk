...
namespace software.amzn.spapi.Api.listings.restrictions.v2021_08_01
{
    /// <summary>
    ...
    public partial class ListingsApi : IListingsApi
    {
        ...
        public ApiResponse< RestrictionList > GetListingsRestrictionsWithHttpInfo (string asin, string sellerId, List<string> marketplaceIds, string? conditionType = null, string? reasonLocale = null)
        {
            ...
            {
                // Exception exception = new Exception("GetListingsRestrictions", localVarResponse.ErrorException);
            ...
            return new ApiResponse<RestrictionList>(localVarResponse.StatusCode,
