...
namespace software.amzn.spapi.Api.uploads.v2020_11_01
{
    /// <summary>
    ...
    public partial class UploadsApi : IUploadsApi
    {
        ...
        /// <returns></returns>
        public UploadsApi(software.amzn.spapi.Client.Configuration configuration)
        {
        ...
        public ApiResponse< CreateUploadDestinationResponse > CreateUploadDestinationForResourceWithHttpInfo (List<string> marketplaceIds, string contentMD5, string resource, string? contentType = null)
        {
            ...
            {
                // Exception exception = new Exception("CreateUploadDestinationForResource", localVarResponse.ErrorException);
            ...
            return new ApiResponse<CreateUploadDestinationResponse>(localVarResponse.StatusCode,
