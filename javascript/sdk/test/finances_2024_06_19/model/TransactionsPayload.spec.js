...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFinances.TransactionsPayload();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFinances.TransactionsPayload.prototype);
  }
});
...
describe('TransactionsPayload', () => {
  it('should create an instance of TransactionsPayload', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFinances.TransactionsPayload);
  });
