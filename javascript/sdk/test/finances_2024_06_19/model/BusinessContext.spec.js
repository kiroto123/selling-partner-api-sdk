...
beforeEach(() => {
  try {
    instance = new TheSellingPartnerApiForFinances.BusinessContext();
  } catch (e) {
    //Handle the cases when this model extends another model by using Model.call(this);
    instance = Object.create(TheSellingPartnerApiForFinances.BusinessContext.prototype);
  }
});
...
describe('BusinessContext', () => {
  it('should create an instance of BusinessContext', () => {
    expect(instance).to.be.a(TheSellingPartnerApiForFinances.BusinessContext);
  });
  ...
  it('should have the property storeName', () => {
    ...
    const expectedValue = ['AMAZON_HAUL', ][0];
