...
export class Address {
   ...
   * @param {module:vendororders_v1/model/Address} obj Optional instance to populate.
   * @return {module:vendororders_v1/model/Address} The populated <code>Address</code> instance.
   */
