 ...
 * @module vendororders_v1/model/Error
 * @version v1
 */
export class Error {
  /**
   ...
   * @alias module:vendororders_v1/model/Error
   * @class
   ...
   * @param {module:vendororders_v1/model/Error} obj Optional instance to populate.
   * @return {module:vendororders_v1/model/Error} The populated <code>Error</code> instance.
   */
