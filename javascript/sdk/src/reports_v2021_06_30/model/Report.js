...
export class Report {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('reportId')) { obj.reportId = ApiClient.convertToType(data.reportId, 'String') }
      ...
      if (data.hasOwnProperty('reportScheduleId')) { obj.reportScheduleId = ApiClient.convertToType(data.reportScheduleId, 'String') }
      ...
      if (data.hasOwnProperty('reportDocumentId')) { obj.reportDocumentId = ApiClient.convertToType(data.reportDocumentId, 'String') }
    }
    return obj
  }
}
