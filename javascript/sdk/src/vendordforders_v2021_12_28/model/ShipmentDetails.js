...
export class ShipmentDetails {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isScheduledDeliveryShipment')) { obj.isScheduledDeliveryShipment = ApiClient.convertToType(data.isScheduledDeliveryShipment, 'Boolean') }
      if (data.hasOwnProperty('isPslipRequired')) { obj.isPslipRequired = ApiClient.convertToType(data.isPslipRequired, 'Boolean') }
      if (data.hasOwnProperty('isGift')) { obj.isGift = ApiClient.convertToType(data.isGift, 'Boolean') }
      if (data.hasOwnProperty('shipMethod')) { obj.shipMethod = ApiClient.convertToType(data.shipMethod, 'String') }
      if (data.hasOwnProperty('shipmentDates')) { obj.shipmentDates = ShipmentDates.constructFromObject(data.shipmentDates) }
      if (data.hasOwnProperty('messageToCustomer')) { obj.messageToCustomer = ApiClient.convertToType(data.messageToCustomer, 'String') }
    }
    return obj
  }
}
