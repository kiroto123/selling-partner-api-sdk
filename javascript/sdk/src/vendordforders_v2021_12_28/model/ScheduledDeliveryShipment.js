...
export class ScheduledDeliveryShipment {
   ...
   * @param {module:vendordforders_v2021_12_28/model/ScheduledDeliveryShipment} obj Optional instance to populate.
   * @return {module:vendordforders_v2021_12_28/model/ScheduledDeliveryShipment} The populated <code>ScheduledDeliveryShipment</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('scheduledDeliveryServiceType')) { obj.scheduledDeliveryServiceType = ApiClient.convertToType(data.scheduledDeliveryServiceType, 'String') }
      if (data.hasOwnProperty('earliestNominatedDeliveryDate')) { obj.earliestNominatedDeliveryDate = ApiClient.convertToType(data.earliestNominatedDeliveryDate, 'Date') }
      if (data.hasOwnProperty('latestNominatedDeliveryDate')) { obj.latestNominatedDeliveryDate = ApiClient.convertToType(data.latestNominatedDeliveryDate, 'Date') }
    }
    return obj
  }
}
