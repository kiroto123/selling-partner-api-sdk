...
export class Address {
   ...
   * @param {module:vendordforders_v2021_12_28/model/Address} obj Optional instance to populate.
   * @return {module:vendordforders_v2021_12_28/model/Address} The populated <code>Address</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attention')) { obj.attention = ApiClient.convertToType(data.attention, 'String') }
