 ...
 * @module solicitations_v1/model/GetSolicitationActionsForOrderResponseEmbedded
 * @version v1
 */
export class GetSolicitationActionsForOrderResponseEmbedded {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('actions')) { obj.actions = ApiClient.convertToType(data.actions, [GetSolicitationActionResponse]) }
    }
    return obj
  }
}
