...
export class GetSolicitationActionResponse {
   ...
   * @alias module:solicitations_v1/model/GetSolicitationActionResponse
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_links')) { obj.links = GetSolicitationActionResponseLinks.constructFromObject(data._links) }
      if (data.hasOwnProperty('_embedded')) { obj.embedded = GetSolicitationActionResponseEmbedded.constructFromObject(data._embedded) }
      if (data.hasOwnProperty('payload')) { obj.payload = SolicitationsAction.constructFromObject(data.payload) }
