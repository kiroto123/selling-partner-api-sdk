...
export class EventBridgeResourceSpecification {
   ...
   * @param {module:notifications_v1/model/EventBridgeResourceSpecification} obj Optional instance to populate.
   * @return {module:notifications_v1/model/EventBridgeResourceSpecification} The populated <code>EventBridgeResourceSpecification</code> instance.
   */
