...
export class SkuQuantity {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('expectedQuantity')) { obj.expectedQuantity = InventoryQuantity.constructFromObject(data.expectedQuantity) }
      if (data.hasOwnProperty('receivedQuantity')) { obj.receivedQuantity = InventoryQuantity.constructFromObject(data.receivedQuantity) }
