...
export class DistributionPackageContents {
   ...
   * @param {module:awd_v2024_05_09/model/DistributionPackageContents} obj Optional instance to populate.
   * @return {module:awd_v2024_05_09/model/DistributionPackageContents} The populated <code>DistributionPackageContents</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('packages')) { obj.packages = ApiClient.convertToType(data.packages, [DistributionPackageQuantity]) }
      if (data.hasOwnProperty('products')) { obj.products = ApiClient.convertToType(data.products, [ProductQuantity]) }
    }
    return obj
  }
}
