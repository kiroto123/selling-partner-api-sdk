...
export class PackageVolume {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('unitOfMeasurement')) { obj.unitOfMeasurement = VolumeUnitOfMeasurement.constructFromObject(data.unitOfMeasurement) }
      if (data.hasOwnProperty('volume')) { obj.volume = ApiClient.convertToType(data.volume, 'Number') }
    }
    return obj
  }
}
