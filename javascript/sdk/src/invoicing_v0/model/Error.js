 ...
 * @module invoicing_v0/model/Error
 * @version v0
 */
export class Error {
  /**
   ...
   * @alias module:invoicing_v0/model/Error
   * @class
   ...
   * @param {module:invoicing_v0/model/Error} obj Optional instance to populate.
   * @return {module:invoicing_v0/model/Error} The populated <code>Error</code> instance.
   */
