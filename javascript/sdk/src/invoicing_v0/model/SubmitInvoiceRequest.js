...
export class SubmitInvoiceRequest {
   ...
   * @param {module:invoicing_v0/model/SubmitInvoiceRequest} obj Optional instance to populate.
   * @return {module:invoicing_v0/model/SubmitInvoiceRequest} The populated <code>SubmitInvoiceRequest</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('InvoiceContent')) { obj.invoiceContent = ApiClient.convertToType(data.InvoiceContent, 'Blob') }
      if (data.hasOwnProperty('MarketplaceId')) { obj.marketplaceId = ApiClient.convertToType(data.MarketplaceId, 'String') }
      if (data.hasOwnProperty('ContentMD5Value')) { obj.contentMD5Value = ApiClient.convertToType(data.ContentMD5Value, 'String') }
    }
    return obj
  }
}
