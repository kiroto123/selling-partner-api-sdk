...
* @alias module:orders_v0/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:orders_v0/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:orders_v0/ApiClient}
*/
