...
export class PackageDetail {
   ...
   * @param orderItems {Array.<module:orders_v0/model/ConfirmShipmentOrderItem>} A list of order items.
   */
   ...
   * @param {module:orders_v0/model/PackageDetail} obj Optional instance to populate.
   * @return {module:orders_v0/model/PackageDetail} The populated <code>PackageDetail</code> instance.
   */
 ...
 * @type {Array.<module:orders_v0/model/ConfirmShipmentOrderItem>}
 */
