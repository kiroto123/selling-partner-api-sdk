...
export class AddressExtendedFields {
   ...
   * @param {module:orders_v0/model/AddressExtendedFields} obj Optional instance to populate.
   * @return {module:orders_v0/model/AddressExtendedFields} The populated <code>AddressExtendedFields</code> instance.
   */
