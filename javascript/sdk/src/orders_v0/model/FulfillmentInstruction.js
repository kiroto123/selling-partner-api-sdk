...
export class FulfillmentInstruction {
   ...
   * @alias module:orders_v0/model/FulfillmentInstruction
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('FulfillmentSupplySourceId')) { obj.fulfillmentSupplySourceId = ApiClient.convertToType(data.FulfillmentSupplySourceId, 'String') }
    }
    return obj
  }
}
