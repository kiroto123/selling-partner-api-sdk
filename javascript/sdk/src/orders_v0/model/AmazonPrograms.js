...
export class AmazonPrograms {
   ...
   * @param {module:orders_v0/model/AmazonPrograms} obj Optional instance to populate.
   * @return {module:orders_v0/model/AmazonPrograms} The populated <code>AmazonPrograms</code> instance.
   */
