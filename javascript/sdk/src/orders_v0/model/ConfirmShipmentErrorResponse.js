...
export class ConfirmShipmentErrorResponse {
   ...
   * @alias module:orders_v0/model/ConfirmShipmentErrorResponse
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:orders_v0/model/ConfirmShipmentErrorResponse} obj Optional instance to populate.
   * @return {module:orders_v0/model/ConfirmShipmentErrorResponse} The populated <code>ConfirmShipmentErrorResponse</code> instance.
   */
