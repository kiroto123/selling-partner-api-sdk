...
export class GetOrderBuyerInfoResponse {
   ...
   * @alias module:orders_v0/model/GetOrderBuyerInfoResponse
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:orders_v0/model/GetOrderBuyerInfoResponse} obj Optional instance to populate.
   * @return {module:orders_v0/model/GetOrderBuyerInfoResponse} The populated <code>GetOrderBuyerInfoResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) { obj.payload = OrderBuyerInfo.constructFromObject(data.payload) }
...
/**
 * @member {module:orders_v0/model/OrderBuyerInfo} payload
 * @type {module:orders_v0/model/OrderBuyerInfo}
 */
