...
export class UpdateVerificationStatusRequest {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('regulatedOrderVerificationStatus')) { obj.regulatedOrderVerificationStatus = UpdateVerificationStatusRequestBody.constructFromObject(data.regulatedOrderVerificationStatus) }
    }
    return obj
  }
}
