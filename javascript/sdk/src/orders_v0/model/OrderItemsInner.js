...
export class OrderItemsInner {
   ...
   * @alias module:orders_v0/model/OrderItemsInner
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:orders_v0/model/OrderItemsInner} obj Optional instance to populate.
   * @return {module:orders_v0/model/OrderItemsInner} The populated <code>OrderItemsInner</code> instance.
   */
