...
export class ExceptionDates {
   ...
   * @alias module:orders_v0/model/ExceptionDates
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ExceptionDate')) { obj.exceptionDate = ApiClient.convertToType(data.ExceptionDate, 'String') }
      if (data.hasOwnProperty('IsOpen')) { obj.isOpen = ApiClient.convertToType(data.IsOpen, 'Boolean') }
      if (data.hasOwnProperty('OpenIntervals')) { obj.openIntervals = ApiClient.convertToType(data.OpenIntervals, [OpenInterval]) }
    }
    return obj
  }
}
