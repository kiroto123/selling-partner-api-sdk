...
export class RegulatedOrderVerificationStatus {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('RequiresMerchantAction')) { obj.requiresMerchantAction = ApiClient.convertToType(data.RequiresMerchantAction, 'Boolean') }
      if (data.hasOwnProperty('ValidRejectionReasons')) { obj.validRejectionReasons = ApiClient.convertToType(data.ValidRejectionReasons, [RejectionReason]) }
      if (data.hasOwnProperty('RejectionReason')) { obj.rejectionReason = RejectionReason.constructFromObject(data.RejectionReason) }
