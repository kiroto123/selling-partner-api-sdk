...
export class DeliveryPreferences {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PreferredDeliveryTime')) { obj.preferredDeliveryTime = PreferredDeliveryTime.constructFromObject(data.PreferredDeliveryTime) }
      if (data.hasOwnProperty('OtherAttributes')) { obj.otherAttributes = ApiClient.convertToType(data.OtherAttributes, [OtherDeliveryAttributes]) }
      if (data.hasOwnProperty('AddressInstructions')) { obj.addressInstructions = ApiClient.convertToType(data.AddressInstructions, 'String') }
    }
    return obj
  }
}
