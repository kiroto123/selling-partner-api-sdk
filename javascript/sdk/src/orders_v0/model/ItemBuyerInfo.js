...
export class ItemBuyerInfo {
   ...
   * @alias module:orders_v0/model/ItemBuyerInfo
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:orders_v0/model/ItemBuyerInfo} obj Optional instance to populate.
   * @return {module:orders_v0/model/ItemBuyerInfo} The populated <code>ItemBuyerInfo</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('GiftWrapTax')) { obj.giftWrapTax = Money.constructFromObject(data.GiftWrapTax) }
      if (data.hasOwnProperty('GiftMessageText')) { obj.giftMessageText = ApiClient.convertToType(data.GiftMessageText, 'String') }
