...
export class BuyerRequestedCancel {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('IsBuyerRequestedCancel')) { obj.isBuyerRequestedCancel = ApiClient.convertToType(data.IsBuyerRequestedCancel, 'String') }
      if (data.hasOwnProperty('BuyerCancelReason')) { obj.buyerCancelReason = ApiClient.convertToType(data.BuyerCancelReason, 'String') }
    }
    return obj
  }
}
