...
export class PreferredDeliveryTime {
   ...
   * @alias module:orders_v0/model/PreferredDeliveryTime
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('BusinessHours')) { obj.businessHours = ApiClient.convertToType(data.BusinessHours, [BusinessHours]) }
      if (data.hasOwnProperty('ExceptionDates')) { obj.exceptionDates = ApiClient.convertToType(data.ExceptionDates, [ExceptionDates]) }
    }
    return obj
  }
}
