...
export class Money {
   ...
   * @alias module:orders_v0/model/Money
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:orders_v0/model/Money} obj Optional instance to populate.
   * @return {module:orders_v0/model/Money} The populated <code>Money</code> instance.
   */
