...
export class OpenInterval {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('StartTime')) { obj.startTime = OpenTimeInterval.constructFromObject(data.StartTime) }
      if (data.hasOwnProperty('EndTime')) { obj.endTime = OpenTimeInterval.constructFromObject(data.EndTime) }
    }
    return obj
  }
}
