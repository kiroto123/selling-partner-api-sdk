...
export class RegulatedInformationField {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('FieldId')) { obj.fieldId = ApiClient.convertToType(data.FieldId, 'String') }
      if (data.hasOwnProperty('FieldLabel')) { obj.fieldLabel = ApiClient.convertToType(data.FieldLabel, 'String') }
      if (data.hasOwnProperty('FieldType')) { obj.fieldType = ApiClient.convertToType(data.FieldType, 'String') }
      if (data.hasOwnProperty('FieldValue')) { obj.fieldValue = ApiClient.convertToType(data.FieldValue, 'String') }
    }
    return obj
  }
}
