...
export class Query {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('processingStartTime')) { obj.processingStartTime = ApiClient.convertToType(data.processingStartTime, 'Date') }
      if (data.hasOwnProperty('processingEndTime')) { obj.processingEndTime = ApiClient.convertToType(data.processingEndTime, 'Date') }
      if (data.hasOwnProperty('dataDocumentId')) { obj.dataDocumentId = ApiClient.convertToType(data.dataDocumentId, 'String') }
      if (data.hasOwnProperty('errorDocumentId')) { obj.errorDocumentId = ApiClient.convertToType(data.errorDocumentId, 'String') }
      if (data.hasOwnProperty('pagination')) { obj.pagination = QueryPagination.constructFromObject(data.pagination) }
    }
    return obj
  }
}
