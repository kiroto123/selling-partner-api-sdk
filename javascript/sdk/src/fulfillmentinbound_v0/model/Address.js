...
export class Address {
   ...
   * @param {module:fulfillmentinbound_v0/model/Address} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v0/model/Address} The populated <code>Address</code> instance.
   */
