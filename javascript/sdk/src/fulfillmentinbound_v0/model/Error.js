...
export class Error {
   ...
   * @param {module:fulfillmentinbound_v0/model/Error} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v0/model/Error} The populated <code>Error</code> instance.
   */
