...
* @alias module:pricing_v0/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:pricing_v0/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:pricing_v0/ApiClient}
*/
