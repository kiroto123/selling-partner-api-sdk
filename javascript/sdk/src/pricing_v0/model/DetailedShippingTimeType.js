...
export class DetailedShippingTimeType {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('minimumHours')) { obj.minimumHours = ApiClient.convertToType(data.minimumHours, 'Number') }
      if (data.hasOwnProperty('maximumHours')) { obj.maximumHours = ApiClient.convertToType(data.maximumHours, 'Number') }
      if (data.hasOwnProperty('availableDate')) { obj.availableDate = ApiClient.convertToType(data.availableDate, 'String') }
