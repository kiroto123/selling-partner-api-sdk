...
export class InvalidItemReason {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invalidItemReasonCode')) { obj.invalidItemReasonCode = InvalidItemReasonCode.constructFromObject(data.invalidItemReasonCode) }
 ...
 * @type {module:fulfillmentoutbound_v2020_07_01/model/InvalidItemReasonCode}
 */
