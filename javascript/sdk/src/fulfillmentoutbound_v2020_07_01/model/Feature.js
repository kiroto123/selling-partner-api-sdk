...
export class Feature {
   ...
   * @param {module:fulfillmentoutbound_v2020_07_01/model/Feature} obj Optional instance to populate.
   * @return {module:fulfillmentoutbound_v2020_07_01/model/Feature} The populated <code>Feature</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('featureDescription')) { obj.featureDescription = ApiClient.convertToType(data.featureDescription, 'String') }
      if (data.hasOwnProperty('sellerEligible')) { obj.sellerEligible = ApiClient.convertToType(data.sellerEligible, 'Boolean') }
    }
    return obj
  }
}
