...
export class GetFulfillmentPreviewResponse {
   ...
   * @alias module:fulfillmentoutbound_v2020_07_01/model/GetFulfillmentPreviewResponse
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:fulfillmentoutbound_v2020_07_01/model/GetFulfillmentPreviewResponse} obj Optional instance to populate.
   * @return {module:fulfillmentoutbound_v2020_07_01/model/GetFulfillmentPreviewResponse} The populated <code>GetFulfillmentPreviewResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) { obj.payload = GetFulfillmentPreviewResult.constructFromObject(data.payload) }
