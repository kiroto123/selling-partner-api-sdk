...
export class GetDeliveryOffersTerms {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('origin')) { obj.origin = Origin.constructFromObject(data.origin) }
      if (data.hasOwnProperty('destination')) { obj.destination = Destination.constructFromObject(data.destination) }
    }
    return obj
  }
}
