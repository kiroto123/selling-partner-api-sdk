...
export class StandardTextPairBlock {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('label')) { obj.label = TextComponent.constructFromObject(data.label) }
      if (data.hasOwnProperty('description')) { obj.description = TextComponent.constructFromObject(data.description) }
    }
    return obj
  }
}
