...
export class Error {
   ...
   * @param {module:vendordfpayments_v1/model/Error} obj Optional instance to populate.
   * @return {module:vendordfpayments_v1/model/Error} The populated <code>Error</code> instance.
   */
