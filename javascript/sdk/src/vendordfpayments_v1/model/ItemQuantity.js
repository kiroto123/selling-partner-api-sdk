...
export class ItemQuantity {
   ...
   * @param {module:vendordfpayments_v1/model/ItemQuantity} obj Optional instance to populate.
   * @return {module:vendordfpayments_v1/model/ItemQuantity} The populated <code>ItemQuantity</code> instance.
   */
