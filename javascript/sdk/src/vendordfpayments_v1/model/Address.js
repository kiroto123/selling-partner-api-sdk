 ...
 * @module vendordfpayments_v1/model/Address
 * @version v1
 */
export class Address {
   ...
   * @alias module:vendordfpayments_v1/model/Address
   * @class
   ...
   * @param city {String} The city where the person, business or institution is located.
   * @param stateOrRegion {String} The state or region where person, business or institution is located.
   * @param postalCode {String} The postal code of that address. It conatins a series of letters or digits or both, sometimes including spaces or punctuation.
   * @param countryCode {String} The two digit country code in ISO 3166-1 alpha-2 format.
   */
  constructor (name, addressLine1, city, stateOrRegion, postalCode, countryCode) {
    this.name = name
   ...
   * @param {module:vendordfpayments_v1/model/Address} obj Optional instance to populate.
   * @return {module:vendordfpayments_v1/model/Address} The populated <code>Address</code> instance.
   */
