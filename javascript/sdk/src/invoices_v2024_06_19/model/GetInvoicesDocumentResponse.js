...
export class GetInvoicesDocumentResponse {
   ...
   * Success.
   * @alias module:invoices_v2024_06_19/model/GetInvoicesDocumentResponse
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:invoices_v2024_06_19/model/GetInvoicesDocumentResponse} obj Optional instance to populate.
   * @return {module:invoices_v2024_06_19/model/GetInvoicesDocumentResponse} The populated <code>GetInvoicesDocumentResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invoicesDocument')) { obj.invoicesDocument = InvoicesDocument.constructFromObject(data.invoicesDocument) }
    }
    return obj
  }
}
