...
export class ExportInvoicesRequest {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dateEnd')) { obj.dateEnd = ApiClient.convertToType(data.dateEnd, 'Date') }
      if (data.hasOwnProperty('dateStart')) { obj.dateStart = ApiClient.convertToType(data.dateStart, 'Date') }
      if (data.hasOwnProperty('externalInvoiceId')) { obj.externalInvoiceId = ApiClient.convertToType(data.externalInvoiceId, 'String') }
      if (data.hasOwnProperty('fileFormat')) { obj.fileFormat = FileFormat.constructFromObject(data.fileFormat) }
      ...
      if (data.hasOwnProperty('series')) { obj.series = ApiClient.convertToType(data.series, 'String') }
