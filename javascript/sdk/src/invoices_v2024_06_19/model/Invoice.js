...
export class Invoice {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('govResponse')) { obj.govResponse = ApiClient.convertToType(data.govResponse, 'String') }
      ...
      if (data.hasOwnProperty('transactionIds')) { obj.transactionIds = ApiClient.convertToType(data.transactionIds, [TransactionIdentifier]) }
