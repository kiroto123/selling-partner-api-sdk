...
export class TransactionReference {
   ...
   * @param {module:vendorshipments_v1/model/TransactionReference} obj Optional instance to populate.
   * @return {module:vendorshipments_v1/model/TransactionReference} The populated <code>TransactionReference</code> instance.
   */
