...
export class ShipmentConfirmation {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('shipmentIdentifier')) { obj.shipmentIdentifier = ApiClient.convertToType(data.shipmentIdentifier, 'String') }
      if (data.hasOwnProperty('shipmentConfirmationType')) { obj.shipmentConfirmationType = ApiClient.convertToType(data.shipmentConfirmationType, 'String') }
      if (data.hasOwnProperty('shipmentType')) { obj.shipmentType = ApiClient.convertToType(data.shipmentType, 'String') }
      if (data.hasOwnProperty('shipmentStructure')) { obj.shipmentStructure = ApiClient.convertToType(data.shipmentStructure, 'String') }
      if (data.hasOwnProperty('transportationDetails')) { obj.transportationDetails = TransportationDetailsForShipmentConfirmation.constructFromObject(data.transportationDetails) }
      if (data.hasOwnProperty('amazonReferenceNumber')) { obj.amazonReferenceNumber = ApiClient.convertToType(data.amazonReferenceNumber, 'String') }
      if (data.hasOwnProperty('shipmentConfirmationDate')) { obj.shipmentConfirmationDate = ApiClient.convertToType(data.shipmentConfirmationDate, 'Date') }
      ...
      if (data.hasOwnProperty('shipmentMeasurements')) { obj.shipmentMeasurements = ShipmentMeasurements.constructFromObject(data.shipmentMeasurements) }
      if (data.hasOwnProperty('importDetails')) { obj.importDetails = ImportDetails.constructFromObject(data.importDetails) }
      if (data.hasOwnProperty('shippedItems')) { obj.shippedItems = ApiClient.convertToType(data.shippedItems, [Item]) }
      if (data.hasOwnProperty('cartons')) { obj.cartons = ApiClient.convertToType(data.cartons, [Carton]) }
