 ...
 * @module vendorshipments_v1/model/ContainerSequenceNumbers
 * @version v1
 */
export class ContainerSequenceNumbers {
   ...
   * @alias module:vendorshipments_v1/model/ContainerSequenceNumbers
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:vendorshipments_v1/model/ContainerSequenceNumbers} obj Optional instance to populate.
   * @return {module:vendorshipments_v1/model/ContainerSequenceNumbers} The populated <code>ContainerSequenceNumbers</code> instance.
   */
