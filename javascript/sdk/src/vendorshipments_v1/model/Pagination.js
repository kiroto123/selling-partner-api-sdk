...
export class Pagination {
   ...
   * @param {module:vendorshipments_v1/model/Pagination} obj Optional instance to populate.
   * @return {module:vendorshipments_v1/model/Pagination} The populated <code>Pagination</code> instance.
   */
