...
export class TransportationDetails {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('shipmentDeliveryDate')) { obj.shipmentDeliveryDate = ApiClient.convertToType(data.shipmentDeliveryDate, 'Date') }
      if (data.hasOwnProperty('carrierDetails')) { obj.carrierDetails = CarrierDetails.constructFromObject(data.carrierDetails) }
