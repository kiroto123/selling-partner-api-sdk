...
export class TaxRegistrationDetails {
   ...
   * @class
   * @param taxRegistrationType {module:vendorshipments_v1/model/TaxRegistrationDetails.TaxRegistrationTypeEnum} Tax registration type for the entity.
   ...
   * @param {module:vendorshipments_v1/model/TaxRegistrationDetails} obj Optional instance to populate.
   * @return {module:vendorshipments_v1/model/TaxRegistrationDetails} The populated <code>TaxRegistrationDetails</code> instance.
   */
 ...
 * @member {module:vendorshipments_v1/model/TaxRegistrationDetails.TaxRegistrationTypeEnum} taxRegistrationType
 * @type {module:vendorshipments_v1/model/TaxRegistrationDetails.TaxRegistrationTypeEnum}
 */
