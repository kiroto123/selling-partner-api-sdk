...
export class Money {
   ...
   * @param {module:vendorshipments_v1/model/Money} obj Optional instance to populate.
   * @return {module:vendorshipments_v1/model/Money} The populated <code>Money</code> instance.
   */
