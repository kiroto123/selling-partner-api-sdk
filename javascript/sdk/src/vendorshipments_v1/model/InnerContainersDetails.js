...
export class InnerContainersDetails {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('containerCount')) { obj.containerCount = ApiClient.convertToType(data.containerCount, 'Number') }
      if (data.hasOwnProperty('containerSequenceNumbers')) { obj.containerSequenceNumbers = ApiClient.convertToType(data.containerSequenceNumbers, [ContainerSequenceNumbers]) }
    }
    return obj
  }
}
