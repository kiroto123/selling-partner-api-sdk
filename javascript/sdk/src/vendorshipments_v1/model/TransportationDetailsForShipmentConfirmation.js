...
export class TransportationDetailsForShipmentConfirmation {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('carrierScac')) { obj.carrierScac = ApiClient.convertToType(data.carrierScac, 'String') }
      if (data.hasOwnProperty('carrierShipmentReferenceNumber')) { obj.carrierShipmentReferenceNumber = ApiClient.convertToType(data.carrierShipmentReferenceNumber, 'String') }
      if (data.hasOwnProperty('transportationMode')) { obj.transportationMode = ApiClient.convertToType(data.transportationMode, 'String') }
