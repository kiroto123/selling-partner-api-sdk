...
export class InventoryUpdate {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isFullUpdate')) { obj.isFullUpdate = ApiClient.convertToType(data.isFullUpdate, 'Boolean') }
      if (data.hasOwnProperty('items')) { obj.items = ApiClient.convertToType(data.items, [ItemDetails]) }
    }
    return obj
  }
}
