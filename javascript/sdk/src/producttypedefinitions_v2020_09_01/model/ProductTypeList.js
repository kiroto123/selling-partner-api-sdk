...
export class ProductTypeList {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('productTypes')) { obj.productTypes = ApiClient.convertToType(data.productTypes, [ProductType]) }
      if (data.hasOwnProperty('productTypeVersion')) { obj.productTypeVersion = ApiClient.convertToType(data.productTypeVersion, 'String') }
    }
    return obj
  }
}
