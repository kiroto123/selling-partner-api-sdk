...
export class ProductTypeVersion {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('version')) { obj.version = ApiClient.convertToType(data.version, 'String') }
      if (data.hasOwnProperty('latest')) { obj.latest = ApiClient.convertToType(data.latest, 'Boolean') }
      if (data.hasOwnProperty('releaseCandidate')) { obj.releaseCandidate = ApiClient.convertToType(data.releaseCandidate, 'Boolean') }
    }
    return obj
  }
}
