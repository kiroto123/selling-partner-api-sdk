...
export class SchemaLinkLink {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('resource')) { obj.resource = ApiClient.convertToType(data.resource, 'String') }
      if (data.hasOwnProperty('verb')) { obj.verb = ApiClient.convertToType(data.verb, 'String') }
    }
    return obj
  }
}
