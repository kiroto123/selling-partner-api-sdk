...
export class PropertyGroup {
   ...
   * @alias module:producttypedefinitions_v2020_09_01/model/PropertyGroup
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('propertyNames')) { obj.propertyNames = ApiClient.convertToType(data.propertyNames, ['String']) }
    }
    return obj
  }
}
