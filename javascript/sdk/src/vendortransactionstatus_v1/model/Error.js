...
export class Error {
   ...
   * @param {module:vendortransactionstatus_v1/model/Error} obj Optional instance to populate.
   * @return {module:vendortransactionstatus_v1/model/Error} The populated <code>Error</code> instance.
   */
