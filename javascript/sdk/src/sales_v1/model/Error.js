...
export class Error {
   ...
   * @alias module:sales_v1/model/Error
   * @class
   ...
   * @param {module:sales_v1/model/Error} obj Optional instance to populate.
   * @return {module:sales_v1/model/Error} The populated <code>Error</code> instance.
   */
