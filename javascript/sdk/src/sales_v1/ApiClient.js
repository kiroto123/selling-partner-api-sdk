...
* @alias module:sales_v1/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:sales_v1/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:sales_v1/ApiClient}
*/
