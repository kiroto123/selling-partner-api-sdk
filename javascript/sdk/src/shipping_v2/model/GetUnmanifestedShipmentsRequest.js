...
export class GetUnmanifestedShipmentsRequest {
  /**
   * Constructs a new <code>GetUnmanifestedShipmentsRequest</code>.
   * The request schema for the GetUnmanifestedShipmentsRequest operation.
   * @alias module:shipping_v2/model/GetUnmanifestedShipmentsRequest
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new GetUnmanifestedShipmentsRequest()
