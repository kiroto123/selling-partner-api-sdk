...
* @alias module:shipping_v2/ApiClient
* @class
*/
export class ApiClient {
    ...
    * @param {module:shipping_v2/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:shipping_v2/ApiClient}
*/
