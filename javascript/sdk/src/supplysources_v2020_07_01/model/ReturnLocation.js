...
export class ReturnLocation {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new ReturnLocation()
      if (data.hasOwnProperty('supplySourceId')) { obj.supplySourceId = ApiClient.convertToType(data.supplySourceId, 'String') }
      if (data.hasOwnProperty('addressWithContact')) { obj.addressWithContact = AddressWithContact.constructFromObject(data.addressWithContact) }
    }
    return obj
  }
}
