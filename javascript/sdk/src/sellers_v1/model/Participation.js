...
export class Participation {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isParticipating')) { obj.isParticipating = ApiClient.convertToType(data.isParticipating, 'Boolean') }
      if (data.hasOwnProperty('hasSuspendedListings')) { obj.hasSuspendedListings = ApiClient.convertToType(data.hasSuspendedListings, 'Boolean') }
    }
    return obj
  }
}
