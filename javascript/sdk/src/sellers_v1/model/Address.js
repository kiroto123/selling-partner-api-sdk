...
export class Address {
   ...
   * @param {module:sellers_v1/model/Address} obj Optional instance to populate.
   * @return {module:sellers_v1/model/Address} The populated <code>Address</code> instance.
   */
