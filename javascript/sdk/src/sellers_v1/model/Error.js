...
export class Error {
   ...
   * @alias module:sellers_v1/model/Error
   * @class
   ...
   * @param {module:sellers_v1/model/Error} obj Optional instance to populate.
   * @return {module:sellers_v1/model/Error} The populated <code>Error</code> instance.
   */
