...
export class Error {
   ...
   * @param {module:merchantfulfillment_v0/model/Error} obj Optional instance to populate.
   * @return {module:merchantfulfillment_v0/model/Error} The populated <code>Error</code> instance.
   */
