...
export class CancelShipmentResponse {
   ...
   * @param {module:merchantfulfillment_v0/model/CancelShipmentResponse} obj Optional instance to populate.
   * @return {module:merchantfulfillment_v0/model/CancelShipmentResponse} The populated <code>CancelShipmentResponse</code> instance.
   */
