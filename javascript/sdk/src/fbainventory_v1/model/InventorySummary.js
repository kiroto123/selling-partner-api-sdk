...
export class InventorySummary {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('productName')) { obj.productName = ApiClient.convertToType(data.productName, 'String') }
      if (data.hasOwnProperty('totalQuantity')) { obj.totalQuantity = ApiClient.convertToType(data.totalQuantity, 'Number') }
      if (data.hasOwnProperty('stores')) { obj.stores = ApiClient.convertToType(data.stores, ['String']) }
    }
    return obj
  }
}
