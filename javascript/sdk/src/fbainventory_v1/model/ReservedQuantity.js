...
export class ReservedQuantity {
   ...
   * @param {module:fbainventory_v1/model/ReservedQuantity} obj Optional instance to populate.
   * @return {module:fbainventory_v1/model/ReservedQuantity} The populated <code>ReservedQuantity</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('totalReservedQuantity')) { obj.totalReservedQuantity = ApiClient.convertToType(data.totalReservedQuantity, 'Number') }
      if (data.hasOwnProperty('pendingCustomerOrderQuantity')) { obj.pendingCustomerOrderQuantity = ApiClient.convertToType(data.pendingCustomerOrderQuantity, 'Number') }
      if (data.hasOwnProperty('pendingTransshipmentQuantity')) { obj.pendingTransshipmentQuantity = ApiClient.convertToType(data.pendingTransshipmentQuantity, 'Number') }
      if (data.hasOwnProperty('fcProcessingQuantity')) { obj.fcProcessingQuantity = ApiClient.convertToType(data.fcProcessingQuantity, 'Number') }
    }
    return obj
  }
}
