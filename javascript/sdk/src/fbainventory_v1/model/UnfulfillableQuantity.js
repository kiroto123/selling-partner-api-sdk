...
export class UnfulfillableQuantity {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('totalUnfulfillableQuantity')) { obj.totalUnfulfillableQuantity = ApiClient.convertToType(data.totalUnfulfillableQuantity, 'Number') }
      if (data.hasOwnProperty('customerDamagedQuantity')) { obj.customerDamagedQuantity = ApiClient.convertToType(data.customerDamagedQuantity, 'Number') }
      if (data.hasOwnProperty('warehouseDamagedQuantity')) { obj.warehouseDamagedQuantity = ApiClient.convertToType(data.warehouseDamagedQuantity, 'Number') }
      if (data.hasOwnProperty('distributorDamagedQuantity')) { obj.distributorDamagedQuantity = ApiClient.convertToType(data.distributorDamagedQuantity, 'Number') }
      if (data.hasOwnProperty('carrierDamagedQuantity')) { obj.carrierDamagedQuantity = ApiClient.convertToType(data.carrierDamagedQuantity, 'Number') }
      if (data.hasOwnProperty('defectiveQuantity')) { obj.defectiveQuantity = ApiClient.convertToType(data.defectiveQuantity, 'Number') }
      if (data.hasOwnProperty('expiredQuantity')) { obj.expiredQuantity = ApiClient.convertToType(data.expiredQuantity, 'Number') }
    }
    return obj
  }
}
