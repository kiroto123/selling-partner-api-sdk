...
export class Granularity {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('granularityType')) { obj.granularityType = ApiClient.convertToType(data.granularityType, 'String') }
      if (data.hasOwnProperty('granularityId')) { obj.granularityId = ApiClient.convertToType(data.granularityId, 'String') }
    }
    return obj
  }
}
