...
export class Container {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('containerIdentifier')) { obj.containerIdentifier = ApiClient.convertToType(data.containerIdentifier, 'String') }
      if (data.hasOwnProperty('trackingNumber')) { obj.trackingNumber = ApiClient.convertToType(data.trackingNumber, 'String') }
      if (data.hasOwnProperty('manifestId')) { obj.manifestId = ApiClient.convertToType(data.manifestId, 'String') }
      if (data.hasOwnProperty('manifestDate')) { obj.manifestDate = ApiClient.convertToType(data.manifestDate, 'String') }
      if (data.hasOwnProperty('shipMethod')) { obj.shipMethod = ApiClient.convertToType(data.shipMethod, 'String') }
      if (data.hasOwnProperty('scacCode')) { obj.scacCode = ApiClient.convertToType(data.scacCode, 'String') }
      if (data.hasOwnProperty('carrier')) { obj.carrier = ApiClient.convertToType(data.carrier, 'String') }
      if (data.hasOwnProperty('containerSequenceNumber')) { obj.containerSequenceNumber = ApiClient.convertToType(data.containerSequenceNumber, 'Number') }
      ...
      if (data.hasOwnProperty('packedItems')) { obj.packedItems = ApiClient.convertToType(data.packedItems, [PackedItem]) }
    }
    return obj
  }
}
