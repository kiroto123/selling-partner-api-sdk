...
export class StatusUpdateDetails {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('statusLocationAddress')) { obj.statusLocationAddress = Address.constructFromObject(data.statusLocationAddress) }
      if (data.hasOwnProperty('shipmentSchedule')) { obj.shipmentSchedule = ShipmentSchedule.constructFromObject(data.shipmentSchedule) }
    }
    return obj
  }
}
...
/**
 * @member {Address} statusLocationAddress
 * @type {Address}
 */
