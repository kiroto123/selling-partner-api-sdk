...
export class ServiceFeeEvent {
   ...
   * @alias module:finances_v0/model/ServiceFeeEvent
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:finances_v0/model/ServiceFeeEvent} obj Optional instance to populate.
   * @return {module:finances_v0/model/ServiceFeeEvent} The populated <code>ServiceFeeEvent</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('FeeReason')) { obj.feeReason = ApiClient.convertToType(data.FeeReason, 'String') }
      ...
      if (data.hasOwnProperty('FeeDescription')) { obj.feeDescription = ApiClient.convertToType(data.FeeDescription, 'String') }
