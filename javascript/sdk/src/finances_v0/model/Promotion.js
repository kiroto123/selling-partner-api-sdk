...
export class Promotion {
   ...
   * @alias module:finances_v0/model/Promotion
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:finances_v0/model/Promotion} obj Optional instance to populate.
   * @return {module:finances_v0/model/Promotion} The populated <code>Promotion</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PromotionAmount')) { obj.promotionAmount = Currency.constructFromObject(data.PromotionAmount) }
    }
    return obj
  }
}
