...
export class RemovalShipmentItem {
   ...
   * @alias module:finances_v0/model/RemovalShipmentItem
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Revenue')) { obj.revenue = Currency.constructFromObject(data.Revenue) }
      ...
      if (data.hasOwnProperty('TaxWithheld')) { obj.taxWithheld = Currency.constructFromObject(data.TaxWithheld) }
    }
    return obj
  }
}
