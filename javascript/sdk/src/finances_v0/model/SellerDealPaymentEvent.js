...
export class SellerDealPaymentEvent {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dealId')) { obj.dealId = ApiClient.convertToType(data.dealId, 'String') }
      if (data.hasOwnProperty('dealDescription')) { obj.dealDescription = ApiClient.convertToType(data.dealDescription, 'String') }
      if (data.hasOwnProperty('eventType')) { obj.eventType = ApiClient.convertToType(data.eventType, 'String') }
