...
export class SellerReviewEnrollmentPaymentEvent {
   ...
   * @alias module:finances_v0/model/SellerReviewEnrollmentPaymentEvent
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('EnrollmentId')) { obj.enrollmentId = ApiClient.convertToType(data.EnrollmentId, 'String') }
      if (data.hasOwnProperty('ParentASIN')) { obj.parentASIN = ApiClient.convertToType(data.ParentASIN, 'String') }
