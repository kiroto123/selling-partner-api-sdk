...
export class RemovalShipmentItemAdjustment {
   ...
   * @alias module:finances_v0/model/RemovalShipmentItemAdjustment
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:finances_v0/model/RemovalShipmentItemAdjustment} obj Optional instance to populate.
   * @return {module:finances_v0/model/RemovalShipmentItemAdjustment} The populated <code>RemovalShipmentItemAdjustment</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('RemovalShipmentItemId')) { obj.removalShipmentItemId = ApiClient.convertToType(data.RemovalShipmentItemId, 'String') }
      if (data.hasOwnProperty('TaxCollectionModel')) { obj.taxCollectionModel = ApiClient.convertToType(data.TaxCollectionModel, 'String') }
      ...
      if (data.hasOwnProperty('AdjustedQuantity')) { obj.adjustedQuantity = ApiClient.convertToType(data.AdjustedQuantity, 'Number') }
      if (data.hasOwnProperty('RevenueAdjustment')) { obj.revenueAdjustment = Currency.constructFromObject(data.RevenueAdjustment) }
      if (data.hasOwnProperty('TaxAmountAdjustment')) { obj.taxAmountAdjustment = Currency.constructFromObject(data.TaxAmountAdjustment) }
      if (data.hasOwnProperty('TaxWithheldAdjustment')) { obj.taxWithheldAdjustment = Currency.constructFromObject(data.TaxWithheldAdjustment) }
    }
    return obj
  }
}
...
/**
 * @member {module:finances_v0/model/Currency} revenueAdjustment
 * @type {module:finances_v0/model/Currency}
 */
RemovalShipmentItemAdjustment.prototype.revenueAdjustment = undefined

/**
 * @member {module:finances_v0/model/Currency} taxAmountAdjustment
 * @type {module:finances_v0/model/Currency}
 */
RemovalShipmentItemAdjustment.prototype.taxAmountAdjustment = undefined

/**
 * @member {module:finances_v0/model/Currency} taxWithheldAdjustment
 * @type {module:finances_v0/model/Currency}
 */
