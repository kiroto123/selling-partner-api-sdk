...
export class AdjustmentEvent {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('AdjustmentType')) { obj.adjustmentType = ApiClient.convertToType(data.AdjustmentType, 'String') }
      ...
      if (data.hasOwnProperty('AdjustmentAmount')) { obj.adjustmentAmount = Currency.constructFromObject(data.AdjustmentAmount) }
      if (data.hasOwnProperty('AdjustmentItemList')) { obj.adjustmentItemList = ApiClient.convertToType(data.AdjustmentItemList, [AdjustmentItem]) }
    }
    return obj
  }
}
