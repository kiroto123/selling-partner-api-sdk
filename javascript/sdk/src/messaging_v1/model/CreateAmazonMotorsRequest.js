...
export class CreateAmazonMotorsRequest {
  /**
   * Constructs a new <code>CreateAmazonMotorsRequest</code>.
   * The request schema for the createAmazonMotors operation.
   * @alias module:messaging_v1/model/CreateAmazonMotorsRequest
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:messaging_v1/model/CreateAmazonMotorsRequest} obj Optional instance to populate.
   * @return {module:messaging_v1/model/CreateAmazonMotorsRequest} The populated <code>CreateAmazonMotorsRequest</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new CreateAmazonMotorsRequest()
 ...
 */
CreateAmazonMotorsRequest.prototype.attachments = undefined
