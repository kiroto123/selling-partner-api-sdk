...
export class CreateConfirmDeliveryDetailsRequest {
   ...
   * @param {module:messaging_v1/model/CreateConfirmDeliveryDetailsRequest} obj Optional instance to populate.
   * @return {module:messaging_v1/model/CreateConfirmDeliveryDetailsRequest} The populated <code>CreateConfirmDeliveryDetailsRequest</code> instance.
   */
