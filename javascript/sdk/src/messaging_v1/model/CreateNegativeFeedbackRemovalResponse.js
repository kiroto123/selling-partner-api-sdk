...
export class CreateNegativeFeedbackRemovalResponse {
   ...
   * @param {CreateNegativeFeedbackRemovalResponse} obj Optional instance to populate.
   * @return {CreateNegativeFeedbackRemovalResponse} The populated <code>CreateNegativeFeedbackRemovalResponse</code> instance.
   */
