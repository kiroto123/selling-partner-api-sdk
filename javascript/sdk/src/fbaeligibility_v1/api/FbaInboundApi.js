...
export class FbaInboundApi {
  ...
  /**
    ...
    * @class
    * @param {module:fbaeligibility_v1/ApiClient} [apiClient] Optional API client implementation to use,
    * default to {@link module:fbaeligibility_v1/ApiClient#instance} if unspecified.
    */
