...
export class Feed {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new Feed()
      if (data.hasOwnProperty('feedId')) { obj.feedId = ApiClient.convertToType(data.feedId, 'String') }
      if (data.hasOwnProperty('feedType')) { obj.feedType = ApiClient.convertToType(data.feedType, 'String') }
      ...
      if (data.hasOwnProperty('resultFeedDocumentId')) { obj.resultFeedDocumentId = ApiClient.convertToType(data.resultFeedDocumentId, 'String') }
    }
    return obj
  }
}
