...
export class CreateFeedSpecification {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('inputFeedDocumentId')) { obj.inputFeedDocumentId = ApiClient.convertToType(data.inputFeedDocumentId, 'String') }
      if (data.hasOwnProperty('feedOptions')) { obj.feedOptions = ApiClient.convertToType(data.feedOptions, { String: 'String' }) }
    }
    return obj
  }
}
