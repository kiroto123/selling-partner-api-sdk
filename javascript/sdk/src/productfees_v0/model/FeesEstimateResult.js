...
export class FeesEstimateResult {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('FeesEstimateIdentifier')) { obj.feesEstimateIdentifier = FeesEstimateIdentifier.constructFromObject(data.FeesEstimateIdentifier) }
      if (data.hasOwnProperty('FeesEstimate')) { obj.feesEstimate = FeesEstimate.constructFromObject(data.FeesEstimate) }
      if (data.hasOwnProperty('Error')) { obj.error = FeesEstimateError.constructFromObject(data.Error) }
    }
    return obj
  }
}
