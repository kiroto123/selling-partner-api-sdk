...
export class Error {
   ...
   * @param {module:productfees_v0/model/Error} obj Optional instance to populate.
   * @return {module:productfees_v0/model/Error} The populated <code>Error</code> instance.
   */
