...
export class FeesEstimate {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('TimeOfFeesEstimation')) { obj.timeOfFeesEstimation = ApiClient.convertToType(data.TimeOfFeesEstimation, 'Date') }
      if (data.hasOwnProperty('TotalFeesEstimate')) { obj.totalFeesEstimate = MoneyType.constructFromObject(data.TotalFeesEstimate) }
      if (data.hasOwnProperty('FeeDetailList')) { obj.feeDetailList = ApiClient.convertToType(data.FeeDetailList, [FeeDetail]) }
    }
    return obj
  }
}
