...
export class Address {
   ...
   * @param {module:vendorinvoices_v1/model/Address} obj Optional instance to populate.
   * @return {module:vendorinvoices_v1/model/Address} The populated <code>Address</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('postalOrZipCode')) { obj.postalOrZipCode = ApiClient.convertToType(data.postalOrZipCode, 'String') }
