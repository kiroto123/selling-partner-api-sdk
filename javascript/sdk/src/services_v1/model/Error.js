 ...
 * @module services_v1/model/Error
 * @version v1
 */
export class Error {
  /**
   ...
   * @alias module:services_v1/model/Error
   * @class
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('errorLevel')) { obj.errorLevel = ApiClient.convertToType(data.errorLevel, 'String') }
    }
    return obj
  }
}
