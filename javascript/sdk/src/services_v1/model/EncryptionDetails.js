...
export class EncryptionDetails {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('standard')) { obj.standard = ApiClient.convertToType(data.standard, 'String') }
      if (data.hasOwnProperty('initializationVector')) { obj.initializationVector = ApiClient.convertToType(data.initializationVector, 'String') }
