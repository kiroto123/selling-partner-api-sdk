...
export class CreateServiceDocumentUploadDestination {
   ...
   * @param {module:services_v1/model/CreateServiceDocumentUploadDestination} obj Optional instance to populate.
   * @return {module:services_v1/model/CreateServiceDocumentUploadDestination} The populated <code>CreateServiceDocumentUploadDestination</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payload')) { obj.payload = ServiceDocumentUploadDestination.constructFromObject(data.payload) }
