...
export class FulfillmentDocument {
   ...
   * @alias module:services_v1/model/FulfillmentDocument
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:services_v1/model/FulfillmentDocument} obj Optional instance to populate.
   * @return {module:services_v1/model/FulfillmentDocument} The populated <code>FulfillmentDocument</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contentSha256')) { obj.contentSha256 = ApiClient.convertToType(data.contentSha256, 'String') }
    }
    return obj
  }
}
