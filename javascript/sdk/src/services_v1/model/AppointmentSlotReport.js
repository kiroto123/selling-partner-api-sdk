...
export class AppointmentSlotReport {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('schedulingType')) { obj.schedulingType = ApiClient.convertToType(data.schedulingType, 'String') }
      ...
      if (data.hasOwnProperty('appointmentSlots')) { obj.appointmentSlots = ApiClient.convertToType(data.appointmentSlots, [AppointmentSlot]) }
    }
    return obj
  }
}
