...
export class Poa {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('technicians')) { obj.technicians = ApiClient.convertToType(data.technicians, [Technician]) }
      if (data.hasOwnProperty('uploadingTechnician')) { obj.uploadingTechnician = ApiClient.convertToType(data.uploadingTechnician, 'String') }
      if (data.hasOwnProperty('uploadTime')) { obj.uploadTime = ApiClient.convertToType(data.uploadTime, 'Date') }
      if (data.hasOwnProperty('poaType')) { obj.poaType = ApiClient.convertToType(data.poaType, 'String') }
    }
    return obj
  }
}
