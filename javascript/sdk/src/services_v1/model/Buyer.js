...
export class Buyer {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new Buyer()
      if (data.hasOwnProperty('buyerId')) { obj.buyerId = ApiClient.convertToType(data.buyerId, 'String') }
      ...
      if (data.hasOwnProperty('isPrimeMember')) { obj.isPrimeMember = ApiClient.convertToType(data.isPrimeMember, 'Boolean') }
    }
    return obj
  }
}
