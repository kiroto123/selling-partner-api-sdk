...
export class AppointmentSlot {
   ...
   * @param {module:services_v1/model/AppointmentSlot} obj Optional instance to populate.
   * @return {module:services_v1/model/AppointmentSlot} The populated <code>AppointmentSlot</code> instance.
   */
