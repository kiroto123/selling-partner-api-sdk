...
export class JobListing {
   ...
   * @param {module:services_v1/model/JobListing} obj Optional instance to populate.
   * @return {module:services_v1/model/JobListing} The populated <code>JobListing</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('totalResultSize')) { obj.totalResultSize = ApiClient.convertToType(data.totalResultSize, 'Number') }
      if (data.hasOwnProperty('nextPageToken')) { obj.nextPageToken = ApiClient.convertToType(data.nextPageToken, 'String') }
      if (data.hasOwnProperty('previousPageToken')) { obj.previousPageToken = ApiClient.convertToType(data.previousPageToken, 'String') }
      if (data.hasOwnProperty('jobs')) { obj.jobs = ApiClient.convertToType(data.jobs, [ServiceJob]) }
    }
    return obj
  }
}
 ...
 * @type {Array.<module:services_v1/model/ServiceJob>}
 */
