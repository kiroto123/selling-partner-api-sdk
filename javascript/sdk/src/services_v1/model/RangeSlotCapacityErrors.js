...
export class RangeSlotCapacityErrors {
   ...
   * @param {module:services_v1/model/RangeSlotCapacityErrors} obj Optional instance to populate.
   * @return {module:services_v1/model/RangeSlotCapacityErrors} The populated <code>RangeSlotCapacityErrors</code> instance.
   */
