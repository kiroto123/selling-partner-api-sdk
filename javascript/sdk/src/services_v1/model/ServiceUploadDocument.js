...
export class ServiceUploadDocument {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contentLength')) { obj.contentLength = ApiClient.convertToType(data.contentLength, 'Number') }
      if (data.hasOwnProperty('contentMD5')) { obj.contentMD5 = ApiClient.convertToType(data.contentMD5, 'String') }
    }
    return obj
  }
}
