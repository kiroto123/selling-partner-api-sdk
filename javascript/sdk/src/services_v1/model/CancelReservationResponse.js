...
export class CancelReservationResponse {
   ...
   * @param {module:services_v1/model/CancelReservationResponse} obj Optional instance to populate.
   * @return {module:services_v1/model/CancelReservationResponse} The populated <code>CancelReservationResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new CancelReservationResponse()
 ...
 */
CancelReservationResponse.prototype.errors = undefined
