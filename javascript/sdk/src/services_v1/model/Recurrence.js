...
export class Recurrence {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('daysOfWeek')) { obj.daysOfWeek = ApiClient.convertToType(data.daysOfWeek, [DayOfWeek]) }
      if (data.hasOwnProperty('daysOfMonth')) { obj.daysOfMonth = ApiClient.convertToType(data.daysOfMonth, ['Number']) }
    }
    return obj
  }
}
