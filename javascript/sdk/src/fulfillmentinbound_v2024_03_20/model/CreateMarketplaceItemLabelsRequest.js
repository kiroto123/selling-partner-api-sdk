...
export class CreateMarketplaceItemLabelsRequest {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('labelType')) { obj.labelType = LabelPrintType.constructFromObject(data.labelType) }
      if (data.hasOwnProperty('localeCode')) { obj.localeCode = ApiClient.convertToType(data.localeCode, 'String') }
      if (data.hasOwnProperty('marketplaceId')) { obj.marketplaceId = ApiClient.convertToType(data.marketplaceId, 'String') }
      if (data.hasOwnProperty('mskuQuantities')) { obj.mskuQuantities = ApiClient.convertToType(data.mskuQuantities, [MskuQuantity]) }
      if (data.hasOwnProperty('pageType')) { obj.pageType = ItemLabelPageType.constructFromObject(data.pageType) }
