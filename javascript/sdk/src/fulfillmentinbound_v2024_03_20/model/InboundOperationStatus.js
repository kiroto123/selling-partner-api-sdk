...
export class InboundOperationStatus {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('operation')) { obj.operation = ApiClient.convertToType(data.operation, 'String') }
      if (data.hasOwnProperty('operationId')) { obj.operationId = ApiClient.convertToType(data.operationId, 'String') }
      if (data.hasOwnProperty('operationProblems')) { obj.operationProblems = ApiClient.convertToType(data.operationProblems, [OperationProblem]) }
      if (data.hasOwnProperty('operationStatus')) { obj.operationStatus = OperationStatus.constructFromObject(data.operationStatus) }
    }
    return obj
  }
}
