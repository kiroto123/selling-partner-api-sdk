...
export class GenerateSelfShipAppointmentSlotsRequest {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('desiredEndDate')) { obj.desiredEndDate = ApiClient.convertToType(data.desiredEndDate, 'Date') }
      if (data.hasOwnProperty('desiredStartDate')) { obj.desiredStartDate = ApiClient.convertToType(data.desiredStartDate, 'Date') }
    }
    return obj
  }
}
