...
export class InboundPlan {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('lastUpdatedAt')) { obj.lastUpdatedAt = ApiClient.convertToType(data.lastUpdatedAt, 'Date') }
      ...
      if (data.hasOwnProperty('packingOptions')) { obj.packingOptions = ApiClient.convertToType(data.packingOptions, [PackingOptionSummary]) }
      if (data.hasOwnProperty('placementOptions')) { obj.placementOptions = ApiClient.convertToType(data.placementOptions, [PlacementOptionSummary]) }
      if (data.hasOwnProperty('shipments')) { obj.shipments = ApiClient.convertToType(data.shipments, [ShipmentSummary]) }
      if (data.hasOwnProperty('sourceAddress')) { obj.sourceAddress = Address.constructFromObject(data.sourceAddress) }
