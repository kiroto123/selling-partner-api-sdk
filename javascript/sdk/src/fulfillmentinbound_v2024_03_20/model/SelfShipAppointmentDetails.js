...
export class SelfShipAppointmentDetails {
   ...
   * @alias module:fulfillmentinbound_v2024_03_20/model/SelfShipAppointmentDetails
   * @class
   */
  constructor () {
  }
   ...
   * @param {module:fulfillmentinbound_v2024_03_20/model/SelfShipAppointmentDetails} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v2024_03_20/model/SelfShipAppointmentDetails} The populated <code>SelfShipAppointmentDetails</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('appointmentId')) { obj.appointmentId = ApiClient.convertToType(data.appointmentId, 'Number') }
      if (data.hasOwnProperty('appointmentSlotTime')) { obj.appointmentSlotTime = AppointmentSlotTime.constructFromObject(data.appointmentSlotTime) }
