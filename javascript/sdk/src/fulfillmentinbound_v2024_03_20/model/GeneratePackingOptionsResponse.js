...
export class GeneratePackingOptionsResponse {
   ...
   * @param {module:fulfillmentinbound_v2024_03_20/model/GeneratePackingOptionsResponse} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v2024_03_20/model/GeneratePackingOptionsResponse} The populated <code>GeneratePackingOptionsResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new GeneratePackingOptionsResponse()
