...
export class ConfirmTransportationOptionsResponse {
   ...
   * @param {module:fulfillmentinbound_v2024_03_20/model/ConfirmTransportationOptionsResponse} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v2024_03_20/model/ConfirmTransportationOptionsResponse} The populated <code>ConfirmTransportationOptionsResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new ConfirmTransportationOptionsResponse()
