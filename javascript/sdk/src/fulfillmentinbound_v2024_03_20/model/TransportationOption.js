...
export class TransportationOption {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('carrierAppointment')) { obj.carrierAppointment = CarrierAppointment.constructFromObject(data.carrierAppointment) }
      if (data.hasOwnProperty('preconditions')) { obj.preconditions = ApiClient.convertToType(data.preconditions, ['String']) }
      if (data.hasOwnProperty('quote')) { obj.quote = Quote.constructFromObject(data.quote) }
      if (data.hasOwnProperty('shipmentId')) { obj.shipmentId = ApiClient.convertToType(data.shipmentId, 'String') }
      if (data.hasOwnProperty('shippingMode')) { obj.shippingMode = ApiClient.convertToType(data.shippingMode, 'String') }
      if (data.hasOwnProperty('shippingSolution')) { obj.shippingSolution = ApiClient.convertToType(data.shippingSolution, 'String') }
