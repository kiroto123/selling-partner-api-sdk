...
export class CreateInboundPlanRequest {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('destinationMarketplaces')) { obj.destinationMarketplaces = ApiClient.convertToType(data.destinationMarketplaces, ['String']) }
      ...
      if (data.hasOwnProperty('sourceAddress')) { obj.sourceAddress = AddressInput.constructFromObject(data.sourceAddress) }
    }
    return obj
  }
}
