...
export class ConfirmTransportationOptionsRequest {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new ConfirmTransportationOptionsRequest()
      if (data.hasOwnProperty('transportationSelections')) { obj.transportationSelections = ApiClient.convertToType(data.transportationSelections, [TransportationSelection]) }
    }
    return obj
  }
}
