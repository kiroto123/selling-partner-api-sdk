...
export class Item {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('expiration')) { obj.expiration = ApiClient.convertToType(data.expiration, 'String') }
      if (data.hasOwnProperty('fnsku')) { obj.fnsku = ApiClient.convertToType(data.fnsku, 'String') }
      if (data.hasOwnProperty('labelOwner')) { obj.labelOwner = ApiClient.convertToType(data.labelOwner, 'String') }
      if (data.hasOwnProperty('manufacturingLotCode')) { obj.manufacturingLotCode = ApiClient.convertToType(data.manufacturingLotCode, 'String') }
