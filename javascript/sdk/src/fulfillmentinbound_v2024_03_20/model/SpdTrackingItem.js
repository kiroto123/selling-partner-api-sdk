...
export class SpdTrackingItem {
   ...
   * @param {module:fulfillmentinbound_v2024_03_20/model/SpdTrackingItem} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v2024_03_20/model/SpdTrackingItem} The populated <code>SpdTrackingItem</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('trackingNumberValidationStatus')) { obj.trackingNumberValidationStatus = ApiClient.convertToType(data.trackingNumberValidationStatus, 'String') }
    }
    return obj
  }
}
