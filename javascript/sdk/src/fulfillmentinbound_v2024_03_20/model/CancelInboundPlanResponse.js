...
export class CancelInboundPlanResponse {
   ...
   * @param {module:fulfillmentinbound_v2024_03_20/model/CancelInboundPlanResponse} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v2024_03_20/model/CancelInboundPlanResponse} The populated <code>CancelInboundPlanResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new CancelInboundPlanResponse()
