...
export class PackageGroupingInput {
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('boxes')) { obj.boxes = ApiClient.convertToType(data.boxes, [BoxInput]) }
      if (data.hasOwnProperty('packingGroupId')) { obj.packingGroupId = ApiClient.convertToType(data.packingGroupId, 'String') }
