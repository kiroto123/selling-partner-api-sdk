...
export class ConfirmPlacementOptionResponse {
   ...
   * @param {module:fulfillmentinbound_v2024_03_20/model/ConfirmPlacementOptionResponse} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v2024_03_20/model/ConfirmPlacementOptionResponse} The populated <code>ConfirmPlacementOptionResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new ConfirmPlacementOptionResponse()
