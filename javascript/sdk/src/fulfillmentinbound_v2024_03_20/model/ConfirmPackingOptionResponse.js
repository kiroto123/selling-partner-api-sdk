...
export class ConfirmPackingOptionResponse {
   ...
   * @param {module:fulfillmentinbound_v2024_03_20/model/ConfirmPackingOptionResponse} obj Optional instance to populate.
   * @return {module:fulfillmentinbound_v2024_03_20/model/ConfirmPackingOptionResponse} The populated <code>ConfirmPackingOptionResponse</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new ConfirmPackingOptionResponse()
 ...
 * @type {String}
 */
ConfirmPackingOptionResponse.prototype.operationId = undefined
