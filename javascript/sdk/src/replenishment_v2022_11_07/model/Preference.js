...
export class Preference {
   ...
   * @param {module:replenishment_v2022_11_07/model/Preference} obj Optional instance to populate.
   * @return {module:replenishment_v2022_11_07/model/Preference} The populated <code>Preference</code> instance.
   */
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('autoEnrollment')) { obj.autoEnrollment = ApiClient.convertToType(data.autoEnrollment, [AutoEnrollmentPreference]) }
    }
    return obj
  }
}
