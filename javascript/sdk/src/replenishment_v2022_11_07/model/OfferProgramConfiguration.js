...
export class OfferProgramConfiguration {
  /**
   * Constructs a new <code>OfferProgramConfiguration</code>.
   * The offer program configuration contains a set of program properties for an offer.
   * @alias module:replenishment_v2022_11_07/model/OfferProgramConfiguration
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      obj = obj || new OfferProgramConfiguration()
      if (data.hasOwnProperty('preferences')) { obj.preferences = OfferProgramConfigurationPreferences.constructFromObject(data.preferences) }
      if (data.hasOwnProperty('promotions')) { obj.promotions = OfferProgramConfigurationPromotions.constructFromObject(data.promotions) }
      if (data.hasOwnProperty('enrollmentMethod')) { obj.enrollmentMethod = EnrollmentMethod.constructFromObject(data.enrollmentMethod) }
    }
    return obj
  }
}
