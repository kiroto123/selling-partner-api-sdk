...
export class ListOfferMetricsResponseOffer {
   ...
   * @alias module:replenishment_v2022_11_07/model/ListOfferMetricsResponseOffer
   * @class
   */
  constructor () {
  }
  ...
  static constructFromObject (data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('next30DayTotalSubscriptionsRevenue')) { obj.next30DayTotalSubscriptionsRevenue = ApiClient.convertToType(data.next30DayTotalSubscriptionsRevenue, 'Number') }
      if (data.hasOwnProperty('next60DayTotalSubscriptionsRevenue')) { obj.next60DayTotalSubscriptionsRevenue = ApiClient.convertToType(data.next60DayTotalSubscriptionsRevenue, 'Number') }
      if (data.hasOwnProperty('next90DayTotalSubscriptionsRevenue')) { obj.next90DayTotalSubscriptionsRevenue = ApiClient.convertToType(data.next90DayTotalSubscriptionsRevenue, 'Number') }
      if (data.hasOwnProperty('next30DayShippedSubscriptionUnits')) { obj.next30DayShippedSubscriptionUnits = ApiClient.convertToType(data.next30DayShippedSubscriptionUnits, 'Number') }
      if (data.hasOwnProperty('next60DayShippedSubscriptionUnits')) { obj.next60DayShippedSubscriptionUnits = ApiClient.convertToType(data.next60DayShippedSubscriptionUnits, 'Number') }
      if (data.hasOwnProperty('next90DayShippedSubscriptionUnits')) { obj.next90DayShippedSubscriptionUnits = ApiClient.convertToType(data.next90DayShippedSubscriptionUnits, 'Number') }
