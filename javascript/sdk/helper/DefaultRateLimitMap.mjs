export const defaultRateLimitMap = {
  ...
  "EasyShipApi-listHandoverSlots": [1, 5],
  "EasyShipApi-getScheduledPackage": [1, 5],
  "EasyShipApi-createScheduledPackage": [1, 5],
  "EasyShipApi-updateScheduledPackages": [1, 5],
  "EasyShipApi-createScheduledPackageBulk": [1, 5],
  ...
  "FbaInboundApi-getShipment": [5, 6],
  "FbaInboundApi-listShipmentBoxes": [5, 30],
  ...
  "FbaInboundApi-listDeliveryWindowOptions": [5, 30],
  ...
  "FbaInboundApi-listTransportationOptions": [5, 6],
  ...
  "ShipmentInvoiceApi-getShipmentDetails": [17, 25, 15],
  "ShipmentInvoiceApi-submitInvoice": [17, 25, 15],
  "ShipmentInvoiceApi-getInvoiceStatus": [17, 25, 15],
  ...
  "ShippingApi-createClaim": [80, 100],
  "ShippingApi-directPurchaseShipment": [80, 100],
  "ShippingApi-generateCollectionForm": [80, 100],
  "ShippingApi-getAccessPoints": [80, 100],
  "ShippingApi-getAdditionalInputs": [80, 100],
  "ShippingApi-getCarrierAccounts": [80, 100],
  "ShippingApi-getCollectionForm": [80, 100],
  "ShippingApi-getCollectionFormHistory": [80, 100],
  "ShippingApi-getShipmentDocuments": [80, 100],
  "ShippingApi-getTracking": [80, 100],
  "ShippingApi-getUnmanifestedShipments": [80, 100],
  "ShippingApi-linkCarrierAccount": [80, 100],
  "ShippingApi-linkCarrierAccount_0": [80, 100],
  "ShippingApi-oneClickShipment": [80, 100],
  "ShippingApi-submitNdrFeedback": [80, 100],
  "ShippingApi-unlinkCarrierAccount": [80, 100],
  "ShippingApi-getCarrierAccountFormInputs": [80, 100],
  ...
  "AutomotiveApi-getVehicles_0": [20, 5],
  ...
  "CustomerFeedbackApi-getItemReviewTopics": [1, 10],
  "CustomerFeedbackApi-getItemBrowseNode": [1, 10],
  "CustomerFeedbackApi-getBrowseNodeReviewTopics": [1, 10],
